...
class TLSConnection(TLSRecordLayer):
    ...
    def _clientSendClientHello(self, settings, session, srpUsername,
        ...
        if settings.explicitCipherSuites is None:
            ...
            cipherSuites = settings.explicitCipherSuites
        ...
        if session and session.sessionID:
            ...
            if session.cipherSuite not in cipherSuites:
                ...
                clientHello.create(settings.maxVersion, getRandomBytes(32),
                                   ...
                                   certificateTypes, 
                                   session.srpUsername,
                                   reqTack, nextProtos is not None, nextProtos if (nextProtos is not None and self.enableALPN) else None,
                                   session.serverName)
