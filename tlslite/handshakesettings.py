...
class HandshakeSettings(object):
    ...
    def __init__(self):
        ...
        self.explicitCipherSuites = None
    ...
    def _filter(self):
        ...
        other.explicitCipherSuites = self.explicitCipherSuites
        ...
        if not other.minVersion in ((0,2), (3,0), (3,1), (3,2)):
            raise ValueError("minVersion set incorrectly")

        if not other.maxVersion in ((0,2), (3,0), (3,1), (3,2)):
