...
sslxray is an SSL/TLS analysis tool designed to identify errors in the implementation and configuration of SSL/TLS. It is currently being developed by Graham Sutherland (GCS).
...
* Randomness tests on ServerRandom are rudimentary and a bit slow (althought better as of 0.1.4)
...
Please submit bugs to the redmine project.
...
If you're not sure, check existing style for precedent. Otherwise, better to ask than guess. This is a long-term project and I don't want messy code!
...
Version 0.1.4:
* Added -S flag for specifying SNI hostname (contrib from Mark Lowe)
